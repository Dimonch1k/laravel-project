<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-700 dark:text-gray-200" type="text"
                name="name" :value="old('name')" required autofocus autocomplete="name" />
            <x-input-error :messages="$errors->get('name')" class="mt-2 dark:text-gray-300" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 dark:text-gray-300" />
        </div>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-4 dark:bg-gray-900 dark:text-gray-200">
                {{ __('Register') }}
            </x-primary-button>
        </div>
    </form>
